...
public class BetAggregationRequestListener implements MessageListener {

    private final Channel channel;
    private final Consumer consumer;
    private String queueName;

    public BetAggregationRequestListener(Channel channel, Consumer consumer, String queueName) {
